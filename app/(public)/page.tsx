...
export default function HomePage() {
  ...
  return <>
    ...
    <footer><div className="ft-top"><a href="#hero" className="logo-link" aria-label="LedBox, volver al inicio"><Image className="logo-img" src="/assets/icon-192.png" alt="LedBox" width={192} height={192} /></a><div className="ft-links"><a href="#productos">Productos</a><a href="#servicios">Servicios</a><a href="#proceso">Proceso</a><a href="#contacto">Contacto</a><a href="https://www.instagram.com/ledboxpy/" target="_blank" rel="noopener noreferrer">Instagram</a></div></div><a className="ft-social" href="https://www.instagram.com/ledboxpy/" target="_blank" rel="noopener noreferrer" aria-label="Instagram @ledboxpy"><InstagramIcon /><span>Instagram · @ledboxpy</span></a><div className="ft-div" /><div className="ft-bottom"><span>© 2026 LedBox Paraguay · Todos los derechos reservados</span><span>Tecnología visual que impulsa tu marca</span><span>Asunción, Paraguay · ledbox.online</span></div><div className="ft-credit"><span>LedBox {APP_VERSION_LABEL}</span><span>Desarrollado por <a href="https://owncoding.dev" target="_blank" rel="noopener noreferrer">owncoding.dev</a></span></div><div className="ft-bg" aria-hidden="true">LEDBOX</div></footer>
