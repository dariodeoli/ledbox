...
/**
 * Diálogo del panel (issue #12): primitivo único con el contrato mínimo (rol
 * dialog, foco al abrir, cierre con Escape y clic afuera). `wide` lo ensancha
 * para las tablas, planes y cronologías.
 */
